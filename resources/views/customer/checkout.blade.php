                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-4">
                                <div class="form-item w-100">
                                    ...
                                    <input name="fullname" type="text" placeholder="Masukkan nama anda"
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="form-item w-100">
                                    ...
                                    <input name="phone" type="text" placeholder="Masukkan nomor WhatsApp"
                                        class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-4">
                                <div class="form-item w-100">
                                    ...
                                    <input type="text" value="{{ $tableNumber ?? 'Tidak ada nomor meja' }}"
