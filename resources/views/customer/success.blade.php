...
@section('content')
    <div class="continer-fluid fruite py-4 d-flex justify-content-center">
        <div class="receipt border p-4 bg-white shadow" style="width: 450px;margin-top: 5rem">
            ...
            @else
                <p class="text-center"><span class="badge bg-success">Pembaryan berhasil, pesanan segera diproses</span></p>
            @endif
            <hr>
